...
import com.example.mycontact.databinding.FragmentNewContactBinding
 ...
 * Use the [NewContact.newInstance] factory method to
    ...
    override fun onCreateView(
        ...
        binding.done.setOnClickListener {
            ...
            if (name.isEmpty() || number.isEmpty()){
             ...
             appData.runContact().addContact(User(name = name, number = number))
